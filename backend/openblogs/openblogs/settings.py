"""
Django settings for openblogs project.
...
WSGI_APPLICATION = 'openblogs.wsgi.application'
...
EMAIL_PORT = 587
EMAIL_HOST_USER = os.getenv('EMAIL_HOST', 'your_default_email')
